...
struct hwrm_cfa_em_flow_alloc_input {
	...
	#define CFA_EM_FLOW_ALLOC_REQ_IP_PROTOCOL_UDP		   0x6UL
	#define CFA_EM_FLOW_ALLOC_REQ_IP_PROTOCOL_TCP		   0x11UL
	u8 unused_2;
	u8 unused_3;
	__be32 src_ipaddr[4];
	__be32 dst_ipaddr[4];
...
struct hwrm_cfa_flow_alloc_input {
	...
	#define CFA_FLOW_ALLOC_REQ_ACTION_FLAGS_PUSH_VLAN	    0x2UL
	#define CFA_FLOW_ALLOC_REQ_ACTION_FLAGS_POP_VLAN	    0x4UL
	#define CFA_FLOW_ALLOC_REQ_ACTION_FLAGS_DROP		    0x8UL
	#define CFA_FLOW_ALLOC_REQ_ACTION_FLAGS_METER		    0x10UL
	#define CFA_FLOW_ALLOC_REQ_ACTION_FLAGS_TUNNEL		    0x20UL
	__le16 dst_fid;
	__be16 act_push_vlan_tpid;
	__be16 act_push_vlan_tci;
	__le16 act_meter_id;
